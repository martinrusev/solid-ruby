...
module Ramon
    ...
    describe 'Web app zeromq test' do
        ...
        it 'Test logging' do
            ...
            Ramon.log({:test => 'data', :more_test => 'more_data'}).should == true
        end	

        it 'Test logging with multiple tags' do
            Ramon.log("test", ['debug', 'benchmark']).should == true
            Ramon.log({:test => 'data', :more_test => 'more_data'}, ['info','warning','user']).should == true
        end


        it 'Test Exceptions' do
            Ramon.post('exception', {:url => 'test', :exception_class => 'test_me'}).should == true
        end
